const UI_TRANSLATIONS = {
    ru: {
        ...
        resources_modal_title: 'Точки опоры',
        resources_modal_sub: 'Ваши личные источники сил, спокойствия и устойчивости. Ассистент опирается на них в трудные минуты.',
        resource_categories_label: 'Категории точек опоры',
        resource_section_all_title: 'Ваша коллекция',
        resource_section_all_desc: 'То, что помогает вернуть спокойствие и ощущение устойчивости.',
        resource_section_joy_title: 'Маленькие радости',
        resource_section_joy_desc: 'Небольшие вещи, которые делают день мягче и теплее.',
        resource_section_body_title: 'Тело и чувства',
        resource_section_body_desc: 'Телесные практики и ощущения, которые помогают вернуться в настоящий момент.',
        resource_section_people_title: 'Люди и контакт',
        resource_section_people_desc: 'Те, рядом с кем можно почувствовать поддержку и безопасность.',
        resource_section_places_title: 'Места и среда',
        resource_section_places_desc: 'Пространства, в которых легче дышать, думать и восстанавливаться.',
        resource_section_creativity_title: 'Дела и творчество',
        resource_section_creativity_desc: 'Занятия, которые возвращают внимание, интерес и ощущение движения.',
        resource_add_title: 'Новая точка опоры',
        resource_title_label: 'Что помогает вам вернуть устойчивость?',
        resource_category_label: 'Категория',
        resource_note_label: 'Заметка',
        cat_all: 'Все опоры',
        cat_joy: 'Маленькие радости',
        cat_body: 'Тело и чувства',
        cat_people: 'Люди и контакт',
        cat_places: 'Места и среда',
        cat_creativity: 'Дела и творчество',
        resource_title_placeholder: 'Например, прогулка, тёплый чай или музыка',
        resource_desc_placeholder: 'Когда это особенно помогает?',
        add_resource_btn: 'Новая опора',
        resource_save: 'Сохранить',
        resource_saving: 'Сохраняем…',
        resource_save_error: 'Не удалось сохранить точку опоры.',
        resource_load_error: 'Не удалось загрузить точки опоры.',
        resource_empty_title: 'Здесь пока пусто',
        resource_empty_desc: 'Сохраняйте здесь то, к чему можно обратиться в трудный момент.',
        resource_delete_confirm: 'Удалить эту точку опоры?',
        close: 'Закрыть',
        resource_added_success: 'Точка опоры сохранена ✓',
        no_resources_msg: 'Пока нет точек опоры. Добавьте любимые ритуалы, занятия или вещи, которые дарят вам устойчивость и покой.',
        resource_saved_by_ai: 'Ассистент сохранил в ваши Точки опоры: ',
    ...
    en: {
        ...
        sidebar_resources: 'Resource Bank',
        ...
        resources_modal_title: 'Grounding Points',
        resources_modal_sub: 'Your personal anchors of calm, strength, and stability. The assistant refers to them during difficult times.',
        resource_categories_label: 'Grounding point categories',
        resource_section_all_title: 'Your collection',
        resource_section_all_desc: 'The things that help you recover calm and a sense of stability.',
        resource_section_joy_title: 'Small Joys',
        resource_section_joy_desc: 'Small things that make the day feel softer and warmer.',
        resource_section_body_title: 'Body & Senses',
        resource_section_body_desc: 'Body practices and sensations that bring you back to the present moment.',
        resource_section_people_title: 'People & Connection',
        resource_section_people_desc: 'People who help you feel supported and safe.',
        resource_section_places_title: 'Places & Environment',
        resource_section_places_desc: 'Spaces where it feels easier to breathe, think, and recover.',
        resource_section_creativity_title: 'Creativity & Focus',
        resource_section_creativity_desc: 'Activities that restore attention, interest, and a sense of momentum.',
        resource_add_title: 'New Grounding Point',
        resource_title_label: 'What helps you feel grounded again?',
        resource_category_label: 'Category',
        resource_note_label: 'Note',
        cat_all: 'All Anchors',
        cat_joy: 'Small Joys',
        cat_body: 'Body & Senses',
        cat_people: 'People & Connection',
        cat_places: 'Places & Environment',
        cat_creativity: 'Creativity & Focus',
        resource_title_placeholder: 'For example, a walk, warm tea, or music',
        resource_desc_placeholder: 'When does this help most?',
        add_resource_btn: 'New Anchor',
        resource_save: 'Save',
        resource_saving: 'Saving…',
        resource_save_error: 'Could not save the grounding point.',
        resource_load_error: 'Could not load grounding points.',
        resource_empty_title: 'Nothing here yet',
        resource_empty_desc: 'Save the things you can return to in a difficult moment.',
        resource_delete_confirm: 'Delete this grounding point?',
        close: 'Close',
        resource_added_success: 'Grounding point saved ✓',
        no_resources_msg: 'No grounding points yet. Add your favorite rituals, activities, or things that restore your calm.',
        resource_saved_by_ai: 'Assistant saved to your Grounding Points: ',
